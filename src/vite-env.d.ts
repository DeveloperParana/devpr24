...
interface CustomGlobalEventHandlers<T> {
  ...
  onBeforeInput: ((this: T, ev: ReplaceTarget<InputEvent, T>) => unknown) | null
  ...
  onContextMenu: ((this: T, ev: ReplaceTarget<MouseEvent, T>) => unknown) | null
  ...
  onFormData: ((this: T, ev: ReplaceTarget<FormDataEvent, T>) => unknown) | null
  onGotPointerCapture:
  ...
  onKeyPress: ((this: T, ev: ReplaceTarget<KeyboardEvent, T>) => unknown) | null
  ...
  onPointerOver:
    | ((this: T, ev: ReplaceTarget<PointerEvent, T>) => unknown)
    | null
  onPointerUp: ((this: T, ev: ReplaceTarget<PointerEvent, T>) => unknown) | null
  onProgress: ((this: T, ev: ReplaceTarget<ProgressEvent, T>) => unknown) | null
